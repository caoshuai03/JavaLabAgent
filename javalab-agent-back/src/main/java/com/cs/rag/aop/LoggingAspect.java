package com.cs.rag.aop;

import com.cs.rag.entity.LogInfo;
import com.cs.rag.service.LogInfoService;
...
public class LoggingAspect {
    ...
    // 定义切点，拦截所有com.cs.rag.controller包下的方法
//        @Pointcut("execution(* com.cs.rag.controller.*.*(..))")
//        public void controllerMethods() {}
    // 定义切点：拦截所有被@Loggable注解标记的方法
    @Pointcut("@annotation(com.cs.rag.annotation.Loggable)")
